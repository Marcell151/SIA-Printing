...
if (isset($_POST['generate'])) {
    ...
    while ($akun = $accounts->fetch_assoc()) {
        ...
        // Calculate saldo from jurnal SAMPAI akhir periode (kumulatif dari awal)
...
<div class="alert alert-warning no-print">
    ...
    <ul class="mb-0 mt-2">
        <li>Neraca Saldo menghitung saldo <strong>KUMULATIF</strong> dari awal sampai akhir periode yang dipilih</li>
        <li>Jika pilih periode <strong>November 2025</strong>, maka akan menghitung semua transaksi dari awal (Oktober + November)</li>
        <li>Jika tidak ada transaksi sampai periode tersebut, Neraca Saldo tidak bisa di-generate</li>
        <li>Untuk melihat saldo setelah penyesuaian, gunakan menu "Neraca Setelah Penyesuaian"</li>
    </ul>
</div>
