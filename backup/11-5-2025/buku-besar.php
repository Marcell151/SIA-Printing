...
<div class="alert alert-warning no-print">
    ...
    <strong>Catatan:</strong> Buku Besar ini menampilkan transaksi SEBELUM jurnal penyesuaian. 
    Jurnal penyesuaian TIDAK termasuk dalam buku besar ini.
    Untuk melihat buku besar setelah penyesuaian, gunakan menu "Buku Besar Setelah Penyesuaian".
</div>
