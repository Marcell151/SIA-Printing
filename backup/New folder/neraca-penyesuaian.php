...
if (isset($_POST['generate'])) {
    ...
    while ($akun = $accounts->fetch_assoc()) {
        ...
        // Calculate saldo INCLUDING ALL adjustments (semua jurnal termasuk penyesuaian)
...
<div class="alert alert-success no-print">
    ...
    <strong>Catatan:</strong> Neraca Saldo ini menampilkan saldo SETELAH jurnal penyesuaian. 
    Semua transaksi termasuk jurnal penyesuaian sudah diperhitungkan dalam neraca ini.
    Saldo di sini adalah dasar untuk membuat Laporan Keuangan (Laba Rugi, Perubahan Modal, Neraca).
</div>
